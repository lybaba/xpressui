...
import { CAMERA_PHOTO_TYPE, DOCUMENT_SCAN_TYPE, EMAIL_TYPE, IMAGE_GALLERY_TYPE, PRODUCT_LIST_TYPE, QR_SCAN_TYPE, SELECT_MULTIPLE_TYPE, SELECT_ONE_TYPE, SETTING_TYPE, TEL_TYPE, TEXTAREA_TYPE, TEXT_TYPE, normalizeFieldName } from "./field";
