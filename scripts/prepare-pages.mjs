...
writeFileSync(
  ...
  [
    ...
    "        </a>",
    "        <a class=\"card\" href=\"./demos/multi-step-review.html\">",
    "          <h2>Multi-Step Review</h2>",
    "          <p>Prévisualisation des données par étape avec résumé final natif.</p>",
    "        </a>",
    ...
    "        </a>",
    "        <a class=\"card\" href=\"./demos/view-photo-gallery.html\">",
    "          <h2>View Photo Gallery</h2>",
    "          <p>Mode view avec policy gallery et rendu média read-only.</p>",
    "        </a>",
    "        <a class=\"card\" href=\"./demos/hybrid-ecommerce.html\">",
    "          <h2>Hybrid E-commerce</h2>",
    "          <p>Mode hybrid avec catalogue produit, output live et submit mocké.</p>",
    "        </a>",
    "        <a class=\"card\" href=\"./demos/quiz-showcase.html\">",
    "          <h2>Quiz Showcase</h2>",
    "          <p>Nouveau champ quiz avec réponses image, max de sélection et question ouverte.</p>",
    "        </a>",
    "        <a class=\"card\" href=\"./demos/hybrid-output-snapshot.html\">",
    "          <h2>Hybrid Output Snapshot</h2>",
    "          <p>Événement output-snapshot et debug panel live sur un formulaire hybride.</p>",
    "        </a>",
    "        <a class=\"card\" href=\"./demos/remote-resume-flow.html\">",
    "          <h2>Remote Save / Resume</h2>",
    "          <p>Cycle complet token distant avec endpoint mocké, debug panel live et synthèse admin locale.</p>",
    "        </a>",
      "      </div>",
    "      <p class=\"sub\">",
